...
- and choose the **play brain** under Sim settings: **Fast** (the proven greedy racer — best for comparisons), **Planner** (searches whole-turn play sequences: energy use, Inflame-before-Strikes, Bash-before-attacks, focus-fire, and a priced kill-now-vs-bank-Vulnerable tradeoff — stronger absolute play, a bit slower), or **Explorer** (high-randomness line hunting; pair with more K to probe a seed's ceiling).
